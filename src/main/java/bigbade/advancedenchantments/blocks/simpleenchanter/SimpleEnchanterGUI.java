...
public class SimpleEnchanterGUI extends GuiContainer {
    /**
     * The ResourceLocation containing the Enchantment GUI texture location
     */
    private static final ResourceLocation ENCHANTMENT_TABLE_GUI_TEXTURE = new ResourceLocation(Reference.MODID.toString(), "textures/gui/container/simple_table.png");
    /**
     * The ResourceLocation containing the texture for the Book rendered above the enchantment table
     */
    private static final ResourceLocation ENCHANTMENT_TABLE_BOOK_TEXTURE = new ResourceLocation(Reference.MODID.toString(), "textures/entity/simple_table_book.png");
    /**
    ...
    private final SimpleEnchanterContainer container;
    ...
    public SimpleEnchanterGUI(InventoryPlayer inventory, World worldIn, String name) {
        super(new SimpleEnchanterContainer(inventory, worldIn));
        this.playerInventory = inventory;
        this.container = (SimpleEnchanterContainer) this.inventorySlots;
        this.name = name;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRenderer.drawString(name, 12, 5, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            if (k1 == 0) {
                ...
                if (((this.mc.player.experienceLevel < k1) && !this.mc.player.capabilities.isCreativeMode) || this.container.enchantClue[l] == -1) // Forge: render buttons as disabled when enchantable but enchantability not met on lower levels
                {
                    this.drawTexturedModalRect(i1, j+14+19*l, 0, 185, 108, 19);
