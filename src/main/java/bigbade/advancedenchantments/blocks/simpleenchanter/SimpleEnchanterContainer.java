...
public class SimpleEnchanterContainer extends Container {
    /**
    ...
    SimpleEnchanterContainer(InventoryPlayer playerInv, World worldIn) {
        this(playerInv, worldIn, BlockPos.ORIGIN);
    }

    public SimpleEnchanterContainer(InventoryPlayer playerInv, World worldIn, BlockPos pos) {
        this.tableInventory = new InventoryBasic("Enchant", true, 2) {
            ...
            public void markDirty() {
                super.markDirty();
                SimpleEnchanterContainer.this.onCraftMatrixChanged(this);
            }
        };
            ...
            if (!itemstack.isEmpty() && itemstack.isItemEnchantable()) {
                if (!this.worldPointer.isRemote) {
                    ...
                    for (int i1 = 0; i1 < 3; ++i1) {
                        this.enchantLevels[i1] = EnchantmentHelper.calcItemStackEnchantability(this.rand, i1, 15, itemstack);
                        ...
                        this.enchantLevels[i1] = net.minecraftforge.event.ForgeEventFactory.onEnchantmentLevelSet(worldPointer, position, i1, 15, itemstack, enchantLevels[i1]);
                    }
    ...
    public boolean enchantItem(EntityPlayer playerIn, int id) {
        ...
        if ((itemstack1.isEmpty() || itemstack1.getCount() < i) && !playerIn.capabilities.isCreativeMode) {
            ...
            if (!this.worldPointer.isRemote) {
                List<EnchantmentData> list = getEnchantmentList(itemstack, id, this.enchantLevels[id]);
