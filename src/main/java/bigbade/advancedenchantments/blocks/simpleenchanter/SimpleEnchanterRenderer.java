...
public class SimpleEnchanterRenderer extends TileEntitySpecialRenderer<SimpleEnchanterTile> {
    /**
     * The texture for the book above the enchantment table.
     */
    private static final ResourceLocation TEXTURE_BOOK = new ResourceLocation("advancedenchantments:textures/entity/simple_table_book.png");
    private final ModelBook modelBook = new ModelBook();

    public void render(SimpleEnchanterTile te, double x, double y, double z, float partialTicks) {
        ...
        for (f1 = te.bookRotation-te.bookRotationPrev; f1 >= (float) Math.PI;) {
            f1 -= ((float) Math.PI*2F);
        }
